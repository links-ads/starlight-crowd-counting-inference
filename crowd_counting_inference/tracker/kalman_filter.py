...
class KalmanFilter(object):
    ...
    def initiate(self, measurement):
        ...
        (ndarray, ndarray)
            ...
            !!!!!!!!!!!! Unobserved velocities are initialized
            to 0 mean. !!!!!!!!!!!!!!!!!!!!!!

        """
        mean_pos = measurement
        mean_vel = np.zeros_like(mean_pos)
        mean = np.r_[mean_pos, mean_vel]  # Concatenate on the fist axis
    ...
    def update(self, mean, covariance, measurement):
        ...
        covariance : ndarray
            The state's covariance matrix (4x4 dimensional).
        measurement : ndarray
            The 4 dimensional measurement vector (x, y), where (x, y)
            is the center position of the
            head.
    ...
    def gating_distance(
        ...
        measurements : ndarray
            ...
            format (x, y) where (x, y) is head center
            position.
